...
class Data {
    ...
    factory Data.fromJson(Map<String, dynamic> json) => Data(
        attivitas: List<Attivita>.from(json["attivitas"].map((x) => Attivita.fromJson(x))),
    );
...
class Attivita {
    ...
    List<AttivitaTipoAttrezzaturaTipoAttrezzatura> attivitaTipoAttrezzaturaTipoAttrezzaturas;
    ...
    factory Attivita.fromJson(Map<String, dynamic> json) => Attivita(
        ...
        nome: json["nome"],
        processoProcessos: List<AttivitaUtenteProfiloAssegnato>.from(json["processoProcessos"].map((x) => AttivitaUtenteProfiloAssegnato.fromJson(x))),
        oggettoOggettos: List<OggettoOggetto>.from(json["oggettoOggettos"].map((x) => OggettoOggetto.fromJson(x))),
        attivitaRicambiTipoRicambios: List<AttivitaRicambiTipoRicambio>.from(json["attivitaRicambiTipoRicambios"].map((x) => AttivitaRicambiTipoRicambio.fromJson(x))),
        attivitaTipoAttrezzaturaTipoAttrezzaturas: List<AttivitaTipoAttrezzaturaTipoAttrezzatura>.from(json["attivitaTipoAttrezzaturaTipoAttrezzaturas"].map((x) => AttivitaTipoAttrezzaturaTipoAttrezzatura.fromJson(x))),
        attivitaUtenteProfiloAssegnato: AttivitaUtenteProfiloAssegnato.fromJson(json["attivitaUtenteProfiloAssegnato"]),
    );
    ...
    Map<String, dynamic> toJson() => {
        ...
        "priorita": priorita,
        "nome": nome,
        "processoProcessos": List<dynamic>.from(processoProcessos.map((x) => x.toJson())),
        "oggettoOggettos": List<dynamic>.from(oggettoOggettos.map((x) => x.toJson())),
        "attivitaRicambiTipoRicambios": List<dynamic>.from(attivitaRicambiTipoRicambios.map((x) => x.toJson())),
        "attivitaTipoAttrezzaturaTipoAttrezzaturas": List<dynamic>.from(attivitaTipoAttrezzaturaTipoAttrezzaturas.map((x) => x.toJson())),
        "attivitaUtenteProfiloAssegnato": attivitaUtenteProfiloAssegnato.toJson(),
    };
}
...
class AttivitaRicambiTipoRicambio {
    ...
    factory AttivitaRicambiTipoRicambio.fromJson(Map<String, dynamic> json) => AttivitaRicambiTipoRicambio(
...
class AttivitaTipoAttrezzaturaTipoAttrezzatura {
    ...
    factory AttivitaTipoAttrezzaturaTipoAttrezzatura.fromJson(Map<String, dynamic> json) => AttivitaTipoAttrezzaturaTipoAttrezzatura(
...
class AttivitaUtenteProfiloAssegnato {
    ...
    factory AttivitaUtenteProfiloAssegnato.fromJson(Map<String, dynamic> json) => AttivitaUtenteProfiloAssegnato(
        nome: json["nome"],
    );
