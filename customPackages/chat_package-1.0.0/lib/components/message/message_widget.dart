...
import 'package:chat_package/components/message/document_message/document_message_widget.dart';
  ...
  Widget messageContent(ChatMessage message) {
    ...
    if (message.chatMedia == null) {
      ...
      return message.chatMedia!.mediaType.maybeWhen(
          ...
          audioMediaType: () => DocumentMessageWidget(
                //SARA' UN DOCUMENTO
                message: message,
                senderColor: senderColor,
                messageContainerTextStyle: messageContainerTextStyle,
              ),
          videoMediaType: () => VideoMessageWidget(
                message: message,
                senderColor: senderColor,
                messageContainerTextStyle: messageContainerTextStyle,
              ),
